  ...
  for (int gl_id_18515 = get_global_id(0);(gl_id_18515 < (n0 / 32));gl_id_18515 = (gl_id_18515 + get_global_size(0))) {
    ...
    for (int i_18877 = 0;(i_18877 < 32);i_18877 = (1 + i_18877)) {
      ...
      for (int i_18915 = 0;(i_18915 < (n1 / 4));i_18915 = (1 + i_18915)) {
        float4 tmp1 = x18403[((((i_18915 + ((2 + i_18877) % 3)) + (((3 * n1) * get_global_id(0)) / 4)) + (3 * get_global_id(0))) + ((n1 * ((2 + i_18877) % 3)) / 4))];
        float4 tmp2 = x18403[(((((1 + i_18915) + ((2 + i_18877) % 3)) + (((3 * n1) * get_global_id(0)) / 4)) + (3 * get_global_id(0))) + ((n1 * ((2 + i_18877) % 3)) / 4))];
        float4 tmp3 = x18403[((((i_18915 + (i_18877 % 3)) + (((3 * n1) * get_global_id(0)) / 4)) + (3 * get_global_id(0))) + ((n1 * (i_18877 % 3)) / 4))];
        float4 tmp4 = x18403[(((((1 + i_18915) + (i_18877 % 3)) + (((3 * n1) * get_global_id(0)) / 4)) + (3 * get_global_id(0))) + ((n1 * (i_18877 % 3)) / 4))];
        float4 tmp5 = x18403[((((i_18915 + ((1 + i_18877) % 3)) + (((3 * n1) * get_global_id(0)) / 4)) + (3 * get_global_id(0))) + ((n1 * ((1 + i_18877) % 3)) / 4))];
        float4 tmp6 = x18403[(((((1 + i_18915) + ((1 + i_18877) % 3)) + (((3 * n1) * get_global_id(0)) / 4)) + (3 * get_global_id(0))) + ((n1 * ((1 + i_18877) % 3)) / 4))];
        ...
        /* oclReduceSeq */
        {
          ...
          x18333 = (x18333 + ((float4)(((float[3]){-0.083333336f, 0.0f, 0.083333336f})[1]) * (float4)(tmp5.s1, tmp5.s2, tmp5.s3, tmp6.s0)));
          x18333 = (x18333 + ((float4)(((float[3]){-0.083333336f, 0.0f, 0.083333336f})[2]) * (float4)(tmp5.s2, tmp5.s3, tmp6.s0, tmp6.s1)));
          x18388[((((i_18915 + ((2 + i_18877) % 3)) + (((3 * n1) * get_global_id(0)) / 4)) + (3 * get_global_id(0))) + ((n1 * ((2 + i_18877) % 3)) / 4))] = x18333;
        }
        ...
        /* oclReduceSeq */
        {
          ...
          x18372 = (x18372 + ((float4)(((float[3]){0.083333336f, 0.16666667f, 0.083333336f})[1]) * (float4)(tmp5.s1, tmp5.s2, tmp5.s3, tmp6.s0)));
          x18372 = (x18372 + ((float4)(((float[3]){0.083333336f, 0.16666667f, 0.083333336f})[2]) * (float4)(tmp5.s2, tmp5.s3, tmp6.s0, tmp6.s1)));
          x18389[((((i_18915 + ((2 + i_18877) % 3)) + (((3 * n1) * get_global_id(0)) / 4)) + (3 * get_global_id(0))) + ((n1 * ((2 + i_18877) % 3)) / 4))] = x18372;
        }
      ...
      for (int i_19200 = 0;(i_19200 < (n1 / 4));i_19200 = (1 + i_19200)) {
        {
          ...
          /* oclReduceSeq */
          {
            ...
            x18214 = (float4)(0.0f);
            /* unrolling loop of 9 */
            x18214 = (x18214 + (float4)((tmp1.s0 * tmp1.s0), (tmp1.s1 * tmp1.s1), (tmp1.s2 * tmp1.s2), (tmp1.s3 * tmp1.s3)));
            x18214 = (x18214 + (float4)((tmp1.s1 * tmp1.s1), (tmp1.s2 * tmp1.s2), (tmp1.s3 * tmp1.s3), (tmp2.s0 * tmp2.s0)));
            x18214 = (x18214 + (float4)((tmp1.s2 * tmp1.s2), (tmp1.s3 * tmp1.s3), (tmp2.s0 * tmp2.s0), (tmp2.s1 * tmp2.s1)));
            x18214 = (x18214 + (float4)((tmp3.s0 * tmp3.s0), (tmp3.s1 * tmp3.s1), (tmp3.s2 * tmp3.s2), (tmp3.s3 * tmp3.s3)));
            x18214 = (x18214 + (float4)((tmp3.s1 * tmp3.s1), (tmp3.s2 * tmp3.s2), (tmp3.s3 * tmp3.s3), (tmp4.s0 * tmp4.s0)));
            x18214 = (x18214 + (float4)((tmp3.s2 * tmp3.s2), (tmp3.s3 * tmp3.s3), (tmp4.s0 * tmp4.s0), (tmp4.s1 * tmp4.s1)));
            x18214 = (x18214 + (float4)((tmp5.s0 * tmp5.s0), (tmp5.s1 * tmp5.s1), (tmp5.s2 * tmp5.s2), (tmp5.s3 * tmp5.s3)));
            x18214 = (x18214 + (float4)((tmp5.s1 * tmp5.s1), (tmp5.s2 * tmp5.s2), (tmp5.s3 * tmp5.s3), (tmp6.s0 * tmp6.s0)));
            x18214 = (x18214 + (float4)((tmp5.s2 * tmp5.s2), (tmp5.s3 * tmp5.s3), (tmp6.s0 * tmp6.s0), (tmp6.s1 * tmp6.s1)));
            x18206 = x18214;
          }
          
          {
            ...
            /* oclReduceSeq */
            {
              ...
              x18181 = (float4)(0.0f);
              /* unrolling loop of 9 */
              x18181 = (x18181 + (float4)((tmp1.s0 * tmp7.s0), (tmp1.s1 * tmp7.s1), (tmp1.s2 * tmp7.s2), (tmp1.s3 * tmp7.s3)));
              x18181 = (x18181 + (float4)((tmp1.s1 * tmp7.s1), (tmp1.s2 * tmp7.s2), (tmp1.s3 * tmp7.s3), (tmp2.s0 * tmp8.s0)));
              x18181 = (x18181 + (float4)((tmp1.s2 * tmp7.s2), (tmp1.s3 * tmp7.s3), (tmp2.s0 * tmp8.s0), (tmp2.s1 * tmp8.s1)));
              x18181 = (x18181 + (float4)((tmp3.s0 * tmp9.s0), (tmp3.s1 * tmp9.s1), (tmp3.s2 * tmp9.s2), (tmp3.s3 * tmp9.s3)));
              x18181 = (x18181 + (float4)((tmp3.s1 * tmp9.s1), (tmp3.s2 * tmp9.s2), (tmp3.s3 * tmp9.s3), (tmp4.s0 * tmp10.s0)));
              x18181 = (x18181 + (float4)((tmp3.s2 * tmp9.s2), (tmp3.s3 * tmp9.s3), (tmp4.s0 * tmp10.s0), (tmp4.s1 * tmp10.s1)));
              x18181 = (x18181 + (float4)((tmp5.s0 * tmp11.s0), (tmp5.s1 * tmp11.s1), (tmp5.s2 * tmp11.s2), (tmp5.s3 * tmp11.s3)));
              x18181 = (x18181 + (float4)((tmp5.s1 * tmp11.s1), (tmp5.s2 * tmp11.s2), (tmp5.s3 * tmp11.s3), (tmp6.s0 * tmp12.s0)));
              x18181 = (x18181 + (float4)((tmp5.s2 * tmp11.s2), (tmp5.s3 * tmp11.s3), (tmp6.s0 * tmp12.s0), (tmp6.s1 * tmp12.s1)));
              x18173 = x18181;
            }
            
            {
              ...
              /* oclReduceSeq */
              {
                ...
                x18148 = (float4)(0.0f);
                /* unrolling loop of 9 */
                x18148 = (x18148 + (float4)((tmp7.s0 * tmp7.s0), (tmp7.s1 * tmp7.s1), (tmp7.s2 * tmp7.s2), (tmp7.s3 * tmp7.s3)));
                x18148 = (x18148 + (float4)((tmp7.s1 * tmp7.s1), (tmp7.s2 * tmp7.s2), (tmp7.s3 * tmp7.s3), (tmp8.s0 * tmp8.s0)));
                x18148 = (x18148 + (float4)((tmp7.s2 * tmp7.s2), (tmp7.s3 * tmp7.s3), (tmp8.s0 * tmp8.s0), (tmp8.s1 * tmp8.s1)));
                x18148 = (x18148 + (float4)((tmp9.s0 * tmp9.s0), (tmp9.s1 * tmp9.s1), (tmp9.s2 * tmp9.s2), (tmp9.s3 * tmp9.s3)));
                x18148 = (x18148 + (float4)((tmp9.s1 * tmp9.s1), (tmp9.s2 * tmp9.s2), (tmp9.s3 * tmp9.s3), (tmp10.s0 * tmp10.s0)));
                x18148 = (x18148 + (float4)((tmp9.s2 * tmp9.s2), (tmp9.s3 * tmp9.s3), (tmp10.s0 * tmp10.s0), (tmp10.s1 * tmp10.s1)));
                x18148 = (x18148 + (float4)((tmp11.s0 * tmp11.s0), (tmp11.s1 * tmp11.s1), (tmp11.s2 * tmp11.s2), (tmp11.s3 * tmp11.s3)));
                x18148 = (x18148 + (float4)((tmp11.s1 * tmp11.s1), (tmp11.s2 * tmp11.s2), (tmp11.s3 * tmp11.s3), (tmp12.s0 * tmp12.s0)));
                x18148 = (x18148 + (float4)((tmp11.s2 * tmp11.s2), (tmp11.s3 * tmp11.s3), (tmp12.s0 * tmp12.s0), (tmp12.s1 * tmp12.s1)));
                x18140 = x18148;
              }
